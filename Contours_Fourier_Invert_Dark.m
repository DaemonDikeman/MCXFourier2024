...
LUT2 = load('C:\Users\daemo\Documents\MATLAB\Generated_LUTs\my_LUT_Fourier_SAC_multilayer_dark_100x100.mat'); %Light SAC multilayer LUT: static top layer, varying bottom layer
% LUT1 = load('C:\Users\daemo\Documents\MATLAB\Generated_LUTs\my_LUT_Fourier_flipped_multilayer_botlayval_[0.002793;1.1688]_100x100.mat'); %DOSI val w/ variable top layer, static bottom layer
% LUT2 = load('C:\Users\daemo\Documents\MATLAB\Generated_LUTs\my_LUT_Fourier_multilayer_toplayval_[0.0002793;0.11688]_100x100.mat'); %DOSI val w/ static top layer, varying bottom layer
...
% LUT2 = load('C:\Users\daemo\Documents\MATLAB\Generated_LUTs\my_LUT_Fourier_SAC_multilayer_tan_100x100.mat'); %Tan SAC multilayer LUT: static top layer, varying bottom layer

contset = linspace(0,0.8,10);
contset2 = linspace(0, 0.8, 41);
wv = 659;
[xq, yq] = meshgrid(0.01:0.01:1, 0.01:0.01:1);
[xq2, yq2] = meshgrid(0.008:0.008:0.80, 0.006:0.006:0.60);
...
sz = size(op_fit_maps3); % uses the static bottom layer OP values
...
% Uses the static top layer OP values pre-thickness correction
LUT3.MuaD = LUT1.Mua(:,:) - 9.10785;
